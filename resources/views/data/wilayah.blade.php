...
<div class="wrapper">
  ...
  <div class="ml-3">
    ...
    <br class="mb-3">
    <form action="{{route('upload_wilayahpost')}}" method="POST">
    {{csrf_field()}}
  <div class="form-group">
    <label for="Name">Kode wilayah</label>
    <input name="id_wilayah" class="form-control" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input name="karakteristik" class="form-control" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    @foreach ($fauna as $q)
      <option name="id_fauna" value="{{$q->ID_fauna}}">{{$q->ID_fauna}}->{{$q->nama_fauna}}</option>
      @endforeach
    </select>
  </div>
