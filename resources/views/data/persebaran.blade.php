...
<div class="wrapper">
  ...
  <div class="ml-3">
    ...
    <br class="mb-3">
    <form action="{{route('upload_persebaranpost')}}" method="POST">
    {{csrf_field()}}
  <div class="form-group">
    <label for="Name">Kode persebaran</label>
    <input name="id_persebaran" class="form-control" >
  </div>
  <div class="form-group">
    <label for="Name">garis persebaran</label>
    <input name="garis_persebaran" class="form-control" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input name="meliputi" class="form-control" >
  </div>
