...
<div class="wrapper">
  ...
  <div class="ml-3">
    <h1 class="m-0 text-monospace">upload data fauna punah</h1>
    <br class="mb-3">
    <form action="{{route('upload_faunapunahpost')}}" method="POST">
    {{csrf_field()}}
  <div class="form-group">
    <label for="Name">Kode fauna punah</label>
    <input name="id_fauna_punah" class="form-control" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea name="catatan_kaki" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
